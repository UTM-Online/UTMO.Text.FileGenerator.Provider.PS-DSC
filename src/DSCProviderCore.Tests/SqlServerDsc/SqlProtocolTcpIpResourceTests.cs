...
[TestClass]
public class SqlProtocolTcpIpResourceTests
{
    [TestMethod]
    public void Create_HappyPath_ReturnsResource()
    {
        var resource = SqlProtocolTcpIpResource.Create("Test", r =>
        {
            r.InstanceName = "value";
            r.IpAddressGroup = "value";
        });
    ...
    {
        var resource = SqlProtocolTcpIpResource.Create("Test", _ => { });
        Assert.AreEqual("SqlProtocolTcpIp", resource.ResourceId);
    }
