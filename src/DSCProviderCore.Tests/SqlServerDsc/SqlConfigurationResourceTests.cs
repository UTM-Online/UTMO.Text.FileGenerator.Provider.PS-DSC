...
[TestClass]
public class SqlConfigurationResourceTests
{
    [TestMethod]
    public void Create_HappyPath_ReturnsResource()
    {
        var resource = SqlConfigurationResource.Create("Test", r =>
        {
    ...
    {
        var resource = SqlConfigurationResource.Create("Test", _ => { });
        Assert.AreEqual("SqlConfiguration", resource.ResourceId);
    }
