...
[TestClass]
public class SqlMaxDopResourceTests
{
    [TestMethod]
    public void Create_HappyPath_ReturnsResource()
    {
        var resource = SqlMaxDopResource.Create("Test", r =>
        {
    ...
    {
        var resource = SqlMaxDopResource.Create("Test", _ => { });
        Assert.AreEqual("SqlMaxDop", resource.ResourceId);
    }
